...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ Storage)\n/* harmony export */ });\n/* harmony import */ var _task_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./task.js */ \"./src/task.js\");\n\n\nclass Storage {\n  static saveToStorage(taskList) {\n    const stringList = JSON.stringify(taskList);\n    window.sessionStorage.setItem('tasklist', stringList);\n  }\n\n  static loadFromStorage(taskList) {\n    const data = window.sessionStorage.getItem('tasklist');\n\n    if (data !== null) {\n      const list = JSON.parse(data);\n      list.forEach((li) => {\n        taskList.push(li);\n      });\n    } else {\n      taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.default('task_1', false, 0));\n      taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.default('task_2', false, 1));\n      taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.default('task_3', false, 2));\n      taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.default('task_4', false, 3));\n      taskList.push(new _task_js__WEBPACK_IMPORTED_MODULE_0__.default('task_5', false, 4));\n    }\n  }\n}\n\n\n//# sourceURL=webpack://webpackproject/./src/storage.js?");
